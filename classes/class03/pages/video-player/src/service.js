...
export default class Service {
  ...
  async handBlinked(video) {
    ...
    for (const prediction of predictions) {
      ...
      const hasLeftEyeBlinked = leftEAR <= EAR_THRESHOLD
      const hasRightEyeBlinked = rightEAR <= EAR_THRESHOLD
      const hasBlinked = hasLeftEyeBlinked && hasRightEyeBlinked

      if (!hasLeftEyeBlinked && !hasRightEyeBlinked) continue
